...
export const segmentos = [
  {
    ...
    cor: '#0ea5e9',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Administrativo, Médica' },
      { nivel: 'Gerência', descricao: 'Hospitalar, Enfermagem, Laboratório' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Enfermagem, Setores, Atendimento' },
      { nivel: 'Equipe operacional', descricao: 'Médicos, enfermeiros, técnicos, recepção' },
      { nivel: 'Cliente', descricao: 'Paciente' },
    ],
  ...
  },
  {
    ...
    cor: '#eab308',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Risco, Compliance, Operações' },
      { nivel: 'Gerência', descricao: 'Tecnologia, Produtos, Agências, Back-office' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Equipes de desenvolvimento, atendimento' },
      { nivel: 'Equipe operacional', descricao: 'Analistas, atendentes, suporte' },
      { nivel: 'Cliente', descricao: 'Correntista, investidor, usuário do app' },
    ],
  ...
  },
  {
    ...
    cor: '#f97316',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Comercial, Operações, Marketing' },
      { nivel: 'Gerência', descricao: 'E-commerce, Lojas, Logística, Estoque' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Regional, equipes de loja, TI' },
      { nivel: 'Equipe operacional', descricao: 'Vendedores, caixa, estoque, suporte online' },
      { nivel: 'Cliente', descricao: 'Consumidor (loja ou e-commerce)' },
    ],
  ...
  },
  {
    ...
    cor: '#64748b',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Industrial, Supply chain, Qualidade' },
      { nivel: 'Gerência', descricao: 'Manutenção, Produção, Logística, Engenharia' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Turnos, células de produção, OT' },
      { nivel: 'Equipe operacional', descricao: 'Operadores, técnicos, almoxarife' },
      { nivel: 'Cliente', descricao: 'Cliente (comprador do produto / supply chain)' },
    ],
  ...
  },
  {
    ...
    cor: '#8b5cf6',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Acadêmica, Administrativa' },
      { nivel: 'Gerência', descricao: 'Secretaria, Coordenação de curso, Suporte EAD' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Professores coordenadores, TI' },
      { nivel: 'Equipe operacional', descricao: 'Professores, secretaria, monitores' },
      { nivel: 'Cliente', descricao: 'Aluno' },
    ],
  ...
  },
  {
    ...
    cor: '#dc2626',
    estruturaEmpresa: [
      { nivel: 'Diretoria', descricao: 'RH, TI, Jurídico, Áreas-fim (saúde, educação, etc.)' },
      { nivel: 'Gerência', descricao: 'Departamentos, Coordenações, TI e Dados' },
      { nivel: 'Coordenação / Supervisão', descricao: 'Equipes, setores, repartições' },
      { nivel: 'Equipe operacional', descricao: 'Servidores, estagiários, terceirizados' },
      { nivel: 'Cliente', descricao: 'Cidadão' },
    ],
